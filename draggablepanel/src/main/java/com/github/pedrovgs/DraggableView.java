...
public class DraggableView extends RelativeLayout {
  ...
  public void preMaximize()
  {
    ...
    playerParams.height = getResources().getDimensionPixelSize(200);
  ...
  public void preMinimize()
  {
    RelativeLayout.LayoutParams playerParams =
            (RelativeLayout.LayoutParams) playerView.getLayoutParams();
    playerParams.width = getResources().getDimensionPixelSize(200);
    playerParams.height = getResources().getDimensionPixelSize(100);
    FrameLayout container = (FrameLayout)playerView.getParent().getParent();
    RelativeLayout.LayoutParams containerParams = (RelativeLayout.LayoutParams)container.getLayoutParams();
    containerParams.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM);
    containerParams.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);
    containerParams.bottomMargin = getResources().getDimensionPixelSize(2);
    containerParams.rightMargin = getResources().getDimensionPixelSize(2);
    playerView.requestLayout();
    container.requestLayout();
